		...
		<footer className="w-full border-t bg-gradient-to-b from-orange-50 via-white to-orange-50 relative overflow-hidden border-orange-200">
			...
			<div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10">
				...
				<div className="grid grid-cols-1 gap-8 sm:gap-10 lg:gap-12 sm:grid-cols-2 lg:grid-cols-5">
					...
					<div className="col-span-1 lg:col-span-2">
						<div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
							<div className="relative">
								<div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-orange-500 flex items-center justify-center font-bold text-orange-100 text-lg sm:text-xl shadow-lg">
									M
								</div>
					...
					{/* Support */}
					<div>
						<h3 className="text-base sm:text-lg font-semibold text-foreground mb-4 sm:mb-6">Support</h3>
						<ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-muted-foreground">
							<li><a className="hover:text-orange-600 transition-colors duration-200 flex items-center gap-2" href="#">
								<span className="w-1 h-1 bg-orange-500 rounded-full"></span>
								Help Center
